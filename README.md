...
## 🌟 Features
*   List of popular peoples peoples with endles scrolling
*   User search can view a detailed description and images on listitems 
...
2. Edit the file com.example.movie.network.NetworkModule and add your key in API_KEY ="" ans ACCESS_TOKEN="
